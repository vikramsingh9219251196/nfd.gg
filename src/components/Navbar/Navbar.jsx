...
const Navbar = () => {
  return (
    <nav offsety={0} className="sc-5c4ac8b4-0 eseZbc">
      <div className="sc-3322ad15-0 sc-5c4ac8b4-1 hPRSGu qKpFW">
        <div
          offsety={0}
          className="sc-5c4ac8b4-8 jJsgTS"
          style={{ height: 75 }}
        >
          <div className="sc-5c4ac8b4-2 jUVxRE">
            <svg
              width={56}
              height={43}
              fill="none"
            ...
            >
              <path d="M0 21.061h11.205v10.97H0V21.06Z" fill="#D6B0FF" />
              <path
                d="m17.928 25.449-6.723 6.582L22.41 42.78 34.51 30.934l-1.793-17.551h-14.79v12.066Z"
                fill="url(#Logo_svg__a)"
              />
              <path d="M11.205 32.03H22.41V43H11.205V32.03Z" fill="#D6B0FF" />
              <path
              ...
              <defs>
                ...
                >
                  <stop offset="0.031" stopColor="#848AFF" />
          ...
          <div className="sc-2ba61756-0 kTFntt">
            <a
              aria-label="Link to About block"
              className="sc-2ba61756-1 bjrFYM"
              href="#about"
            >
              About
            </a>
            <a
              aria-label="Link to Aggregator block"
              className="sc-2ba61756-1 bjrFYM"
              href="#aggregator"
            >
              Aggregator
            ...
            <a
              aria-label="Link to Features block"
              className="sc-2ba61756-1 bjrFYM"
              href="#features"
            >
              Features
            ...
            <a
              aria-label="Link to Roadmap block"
              className="sc-2ba61756-1 bjrFYM"
              href="#roadmap"
            >
              Roadmap
            ...
            <a
              aria-label="Link to Contact us block"
              className="sc-2ba61756-1 bjrFYM"
              href="/#contact"
            >
              Contact us
          ...
          <div className="sc-5c4ac8b4-4 hjVyhA">
            <div className="sc-5c4ac8b4-5 iHbRia">
              <a href="/#">
        ...
        <div className="sc-5c4ac8b4-9 jppiNf">
          <div className="sc-5c4ac8b4-3 guJiee">
            <svg
              width={56}
              height={43}
              fill="none"
          ...
          >
            ...
            <rect y={10} width={15} height={3} rx="1.5" fill="#171717" />
          </svg>
        </div>
      </div>
    </nav>
